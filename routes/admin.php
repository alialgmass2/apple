...
// DASHBOARD START
        Route::get('/dashboard', 'App\Livewire\Admin\Dashboard')->name('dashboard');
// DASHBOARD END
// REGIONS START
...
// MISSION BANNER END
// ORDERS START
Route::get('/orders', 'App\Livewire\Admin\Orders\Index')->name('orders.index');
Route::get('/orders/{order}', 'App\Livewire\Admin\Orders\Show')->name('orders.show');
// ORDERS END
// ORDERS START
//Route::get('/pickup-address', 'App\Livewire\Admin\Pickup\Index')->name('pickup.index');
//Route::get('/pickup-address/{order}', 'App\Livewire\Admin\Pickup\Show')->name('pickup.show');
// ORDERS END
//// ORDERS START
Route::get('/payments', 'App\Livewire\Admin\Payments\Index')->name('payments.index');
Route::get('/payments/{index}/{id}', 'App\Livewire\Admin\Payments\Show')->name('payments.show');
// ORDERS END
// COURSES START
...
// TO GET FILES FROM STORAGE START
        Route::any('/files/{path}', [AdminController::class, 'uploads'])->name('uploads');
