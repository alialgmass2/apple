                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link notification-wrap"   href="{{route('user.notification')}}">
                                     <i class="fa-regular fa-bell"></i>
                                    @if(authUser()->unreadNotifications()->exists())
                                        <span class="badge-notification">{{authUser()->unreadNotifications()->count()}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" target="_blank" href="{{ route('user.organization.organizations') }}">
