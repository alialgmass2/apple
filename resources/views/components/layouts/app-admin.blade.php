...
<head>
    ...
    <meta name="author" content="Jaar platform">
    <meta name="robots" content="">
    <meta name="keywords"
        content="Jaar platform">
    <meta name="description"
        content="Jaar platform">
    <meta property="og:title" content="Jaar platform">
...
<body>
    ...
    ********************-->
    <div id="preloader">
        <div class="waviy">
            <img class="logo-loading" src="{{ asset('images/logo.png') }}" alt="" />
        </div>
    </div>
    <!--*******************
        Preloader end
        ...
        ***********************************-->
        <div class="header">
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                               <a class="nav-link notification-wrap"  href="{{route('admin.notification')}}">
                                     <i class="fa-regular fa-bell"></i>
                                   @if(authAdmin()->unreadNotifications()->exists())
                                     <span class="badge-notification">{{authAdmin()->unreadNotifications()->count()}}</span>
                                   @endif
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <img src="{{ asset('images/avatar.jpg') }}" alt="" class="avatar" />

                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="dlab_W_TimeLine02" class="widget-timeline dlab-scroll style-1 p-3">
                                        <ul>
                                            <li class="avatar-menu">
                                                <a class="text-muted" href="javascript:void(0);">Profile</a>
                                            </li>
                                            <li class="avatar-menu">
                                                <a class="text-muted" href="{{ route('admin.logout') }}">Logout</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="ms-5 d-flex justify-content-between">
                ...
                {{-- <div class="breadcrumb-right pe-5">
    ...
    ***********************************-->
    ...
    <script src="{{ asset('assets/js/invoicePrint.js') }}"> </script>
    @stack('js')
