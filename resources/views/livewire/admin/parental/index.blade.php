<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.parentals')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                @forelse ($parentals as $parental)

                                <tr>
                                    <td>
                                        <strong>{{ $parental->id }}</strong>
                                    </td>
                                    <td>
                                        <img class="file-preview" src="{{ $parental->getFile() }}" alt="" />
                                    </td>
                                    <td>{{ $parental->translate('text') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            {{-- <a href="{{ route('admin.parental.show',[$parental->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $parental->id }})"><i
                                            ...
                                            {{-- <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $parental->id }})"></i></a>
                                            --}}
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit Parental</h5>
                            @else
                            <h5 class="text-center mb-4">Add New Parental</h5>
                            @endif
                        </div>
