<div>
    <x-slot name="title"> @lang('app.dashboard') | @lang('app.contact')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.contact')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.itcontactus.show',[$contact->id]) }}"
