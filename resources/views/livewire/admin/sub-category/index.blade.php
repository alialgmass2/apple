<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.sub_categories')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                        ...
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $subCategory->translate('name') }}</td>
                                    <td>{{ $subCategory->category->translate('name') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="#" class="btn btn-xs sharp me-1 text-primary fz-16px"
                                                wire:loading.class="disabled"
                                                wire:click.prevent="showModalEdit({{ $subCategory->id }})"><i
                                            ...
                                            <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $subCategory->id }})"></i></a>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-xl-12 col-lg-12">
                        @if ($isEditMode)
                        <h5 class="text-center mb-4">Edit Sub Category</h5>
                        @else
                        <h5 class="text-center mb-4">Add New Sub Category</h5>
                        @endif
                    </div>
                    <div class="col-xl-12 col-lg-12">
                        <x-admin.select title="Category" error="category_id" wire:model="state.category_id">
