<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.leadershipintro')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card"> 
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <strong>{{ $leadershipIntro->id }}</strong>
                                    </td>
                                    <td>{{ $leadershipIntro->translate('title') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.leadershipintro.show',[$leadershipIntro->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $leadershipIntro->id }})"><i
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit leadershipIntro</h5>
                            @else
                            <h5 class="text-center mb-4">Add New leadershipIntro</h5>
                            @endif
                        </div>
