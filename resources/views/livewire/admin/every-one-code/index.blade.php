<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.everyonecodes')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>{{ $everyOneCode->id }}</strong>
                                    </td>
                                    <td>
                                        <img class="file-preview" src="{{ $everyOneCode->getFile() }}" alt="" />
                                    </td>
                                    <td>{{ $everyOneCode->translate('title') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.everyonecode.show',[$everyOneCode->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $everyOneCode->id }})"><i
                                            ...
                                            <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $everyOneCode->id }})"></i></a>
                                        </div>
                                    </td>
                                </tr>
