<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.missions')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                        ...
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img class="file-preview" src="{{ $mission->getFile() }}" alt="" />
                                    </td>
                                    <td>{{ $mission->translate('title') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.mission.show',[$mission->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $mission->id }})"><i
                                            ...
                                            <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $mission->id }})"></i></a>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit mission</h5>
                            @else
                            <h5 class="text-center mb-4">Add New mission</h5>
                            @endif
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <x-admin.textarea title="text_en" error="text_en"
                                wire:model="state.text_en" />
                        </div>

                        <div class="col-xl-6 col-lg-6">
                            <x-admin.textarea title="text_ar" error="text_ar"
                                wire:model="state.text_ar" />
                        </div>
                ...
                <div class="modal-footer justify-content-between border-0">
                    ...
                    @else
                    <x-admin.button  class="btn-sm btn-outline-dark btn-block"  wire:loading.class="disabled"   wire:click.prevent="store">Submit
                    </x-admin.button>
                    @endif
                </div>
            </div>
