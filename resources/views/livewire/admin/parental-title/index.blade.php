<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.parentaltitles')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>{{ $parentaltitle->id }}</strong>
                                    </td>

                                    <td>{{ $parentaltitle->translate('title') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            {{-- <a href="{{ route('admin.parentaltitle.show',[$parentaltitle->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $parentaltitle->id }})"><i
                                            ...
                                            <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $parentaltitle->id }})"></i></a>
                                        </div>
                                    </td>
                                </tr>
