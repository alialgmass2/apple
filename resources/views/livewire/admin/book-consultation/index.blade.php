<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.bookconsultation')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <strong>{{ $bookConsultation->id }}</strong>
                                    </td>
                                    <td>{{ $bookConsultation->translate('text') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.bookconsultation.show',[$bookConsultation->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $bookConsultation->id }})"><i
