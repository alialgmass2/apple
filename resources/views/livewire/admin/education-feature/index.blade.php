                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>{{ $educationFeature->id }}</strong>
                                    </td>
                                    <td>
                                        <img class="file-preview" src="{{ $educationFeature->getFile() }}" alt="" />
                                    </td>
                                    <td>{{ $educationFeature->translate('title') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.educationfeature.show',[$educationFeature->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $educationFeature->id }})"><i
                                            ...
                                            <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $educationFeature->id }})"></i></a>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit Education Feature</h5>
                            @else
                            <h5 class="text-center mb-4">Add New Education Feature</h5>
                            @endif
                        </div>
