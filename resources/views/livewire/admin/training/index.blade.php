<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.training')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card"> 
                        ...
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {{-- <td>
                                        <img class="file-preview" src="{{ $training->getFile() }}" alt="" />
                                    </td> --}}
                                    <td>{{ $training->translate('title') }}</td>
                                    {{-- <td>{{ $training->translate('text') }}</td> --}}
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $training->id }})"><i
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit training</h5>
                            @else
                            <h5 class="text-center mb-4">Add New training</h5>
                            @endif
                        </div>
