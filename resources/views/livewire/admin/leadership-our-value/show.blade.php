<div class="card-body bg-white">
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.leadershipourvalue.index') }}">@lang('app.leadershipourvalues')</a></li>
        ...
        <table class="table table-responsive-md table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $leadershipourvalue->translate('text') }}</td>
                </tr>
                <tr>
                    <td class="font-bold">@lang('app.created_at')</td>
                    <td>{{ $leadershipourvalue->created_at }}</td>
                </tr>
            </tbody>
        </table>
    </div>
