<div class="card-body bg-white">
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.onlinecourse.index') }}">@lang('app.onlinecourse')</a></li>
    ...
    <div class="table-responsive">
        <table class="table table-responsive-md table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td class="font-bold">@lang('app.title_2')</td>
                    <td>{{ $onlinecourse->translate('title_2') }}</td>
                </tr>
                <tr>
                    <td class="font-bold">@lang('app.created_at')</td>
                    <td>{{ $onlinecourse->created_at }}</td>
                </tr>
            </tbody>
        </table>
    </div>
