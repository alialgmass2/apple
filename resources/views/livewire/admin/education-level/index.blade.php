<div>
    <x-slot name="title"> @lang('app.dashboard') | @lang('app.education_level')</x-slot>
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('app.dashboard')</a></li>
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.education_level')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header  justify-content-end">
                    ...
                    <h4 class="card-title">
                        <x-admin.button-create title="education_level" wire:click="showModal" />
                    </h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><strong>{{ $educationLevel->id }}</strong></td>
                                    <td>{{ $educationLevel->translate('name') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="#" class="btn btn-xs sharp me-1 text-primary fz-16px"
                                                wire:loading.class="disabled"
                                                wire:click.prevent="showModalEdit({{ $educationLevel->id }})"><i
                                            ...
                                            <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $educationLevel->id }})"></i></a>
                                        </div>
                                    </td>
                                </tr>
    ...
    {{-- MODAL START --}}
    <x-admin.modal title="education_level" :isModalShow="$isModalShow" :isEditMode="$isEditMode">
