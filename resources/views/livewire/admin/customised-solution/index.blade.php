<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.customisedsolutions')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card"> 
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <strong>{{ $customisedSolution->id }}</strong>
                                    </td>
                                    <td>{{ $customisedSolution->translate('text') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.customisedsolution.show',[$customisedSolution->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $customisedSolution->id }})"><i
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit customisedSolution</h5>
                            @else
                            <h5 class="text-center mb-4">Add New customisedSolution</h5>
                            @endif
                        </div>
