<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.banners')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                        ...
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                               <tr>
                                    ...
                                    <td>
                                        <img class="file-preview" src="{{ $banner->getFile() }}" alt="" />
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px" wire:loading.class="disabled"
                                                wire:click.prevent="showModalEdit({{ $banner->id }})"><i class="fa-regular fa-pen-to-square"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
