<div>
    <x-slot name="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">@lang('app.everyonecreates')</a></li>
    </x-slot>
    <div class="row">
        <div class="col-lg-12">
            <div class="card"> 
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive-md table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>{{ $everyOneCreate->id }}</strong>
                                    </td>
                                    <td>
                                        <img class="file-preview" src="{{ $everyOneCreate->getFile() }}" alt="" />
                                    </td>
                                    <td>{{ $everyOneCreate->translate('text') }}</td>
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            <a href="{{ route('admin.everyonecreate.show',[$everyOneCreate->id]) }}"
                                            ...
                                            <a href="#" class="btn btn-xs sharp mx-1 text-primary fz-16px"
                                                ...
                                                wire:click.prevent="showModalEdit({{ $everyOneCreate->id }})"><i
                                            ...
                                            {{-- <a href="#" class="btn btn-xs sharp text-danger fz-16px"><i
                                                    ...
                                                    wire:click.prevent="delete({{ $everyOneCreate->id }})"></i></a> --}}
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            @if ($isEditMode)
                            <h5 class="text-center mb-4">Edit Every One Create</h5>
                            @else
                            <h5 class="text-center mb-4">Add New Every One Create</h5>
                            @endif
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <x-admin.input title="findout_link" error="findout_link" wire:model="state.findout_link" />
                        </div>
                        <div class="col-xl-6 col-lg-6">
                            <x-admin.input title="download_link" error="download_link"
                                wire:model="state.download_link" />
                        </div>
