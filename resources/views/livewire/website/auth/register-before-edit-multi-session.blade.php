        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-5 bg-white">
                ...
                <div class="auth-logo d-flex justify-content-center align-items-center flex-column">
                    ...
                    <p class="text-center">Enter the OTP code that we sent to your emails {{ mb_substr($registerStepData->email,0,4) }}****@ {{ $registerStepData->organization->domain }}
                    ...
                    <form wire:submit.prevent="register" class="h-250px">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="mt-4 d-flex justify-content-between w-100 align-items-center">
                                {{-- @if ($currentStep != 1) --}}
                                <button class="btn btn-outline-light btn-lg @if ($currentStep == 3 || $currentStep == 4)
                               @else
                               ml-30px
                                @endif" type="button"
                                ...
                                @endif
                                " type="button"
                                    wire:loading.attr="disabled" wire:click="increaseStep">Next</button>
                            </div>
