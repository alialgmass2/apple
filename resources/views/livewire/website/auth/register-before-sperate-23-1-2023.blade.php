        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="auth-logo d-flex justify-content-center align-items-center flex-column mx-auto" style="max-width:488px;">
                    <img src="{{ asset('images/logo-white.png') }}" alt="" width="60%;" />
                    <h2 class="mt-2 text-center">Sign up</h2>
                    @if ($currentStep == 1)
                    <p class="text-center">Sign up to create Apple education account</p>
                    <p class="text-center">Step number (1/4)</p>
                    @elseif ($currentStep == 2)
                    <p class="text-center">Sign up to create Apple education account</p>
                    <p class="text-center">Step number (2/4)</p>
                    @elseif ($currentStep == 3)
                    <p class="text-center">Sign up to create Apple education account</p>
                    <p class="text-center">Step number (3/4)</p>
                    ...
                    <form wire:submit.prevent="register" class="h-250px">
                            ...
                            <div class="input-group mb-3 flex-column">
                                <div class="w-100 d-flex">
                                    <input type="password" class="form-control" aria-label=""
                                        aria-describedby="basic-addon2" wire:model="password" placeholder="Password">
                                    {{-- <span class="input-group-text auth-prefix" id="basic-addon2">@ {{
                                        $registerStepOrgnization->domain }}</span> --}}
                                </div>
                                @error('password')
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="text-center d-flex flex-column">
                                <button class="btn btn-outline-dark btn-lg btn-register-verifiy bg-yellow" type="button" wire:click="register()">Verify
                                    Email</button>
                            ...
                            <div class="mt-4 d-flex justify-content-between w-100 align-items-center">
                                {{-- @if ($currentStep != 1) --}}
                                <button class="btn btn-outline-light btn-lg btn-back-in-register @if ($currentStep == 3 || $currentStep == 4)
                               @else
                               {{-- ml-30px --}}
                                @endif" type="button" wire:click="decreaseStep">Back</button>
                                {{-- @endif --}}
                                <button class="btn btn-outline-dark btn-lg ms-auto btn-back-in-register bg-yellow
