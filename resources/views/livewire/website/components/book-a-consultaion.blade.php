<div>
    <section class="bookConsultation  @if ($isModalContactShow)
        padding-0
    @endif" id="book-consuation-id">
        <div class="">

            <div class="container   @if ($isModalContactShow)
    hide
    @else
    display-block
@endif  ">
                <h2 class="bookConsultation_head">@lang('app.book_a_consultation_now')</h2>
                <p class="bookConsultation_paragraph--1">@lang('app.book_a_consultation_text')</p>
                <button class="bookConsultation_button" wire:click.prevent="openContactModal">@lang('app.book_a_consultation_now')</button>
            </div>
            ...
            <div id="parent" class="@if ($isModalContactShow)
                ...
                <div class="parent">
                    ...
                    <div class="content-contact">
                        <div class="title">
                            <p>@lang('app.book_a_consultation')</p>
                        </div>
                        <div class="form">
                            @if ($errors->any())
                            ...
                            <form action="">
                                <div class="from-content">
                                    ...
                                    <input type="email" name="email" class="@error('email')
                                                                border-red
                                                            @enderror" id="" placeholder="@lang('app.placeholder_email')"
                                    ...
                                    <input type="tel" name="mobile" class="@error('phone')
                                                                border-red
                                                            @enderror" id="" placeholder="@lang('app.placeholder_mobile')"
                                        pattern="[0-9]{11}" wire:model="state.phone">
                                ...
                                <button type="button" class="button" wire:click.prevent="sendMessage"><span class="show"
                                        wire:loading.attr="disabled">@lang('app.submit')</span>
