<div>
    ...
    @else
     display-block
@endif">@lang('app.get_in_touch_with_our_engineers')</h2>
                        ...
                        <form action="">
                            <div class="from-content">
                                ...
                                <input id="" type="text" class="@error('institution')
                                        border-red
                                    @enderror" placeholder="@lang('app.placeholder_institution')" wire:model="state.institution">


                                <input type="tel" name="mobile" class="@error('phone')
                                        border-red
                                    @enderror" id="" placeholder="Phone number" pattern="[0-9]{11}"
